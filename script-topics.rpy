...
label monika_lottery:
    ...
    m 3a "Even Iâve entertained the idea every now and then."
    ...
    m "Sure, youâve got all this money..."
    m 3e "But because of it, people look at you differently."
    m "Thereâs so many stories of people winning a ton of money..."
    ...
    m 4l "But thatâs an awful thought. Cutting yourself off from everyone you know, just for the sake of money."
    m 4e "Can you really say that youâve won anything at that point?"
    m 1b "Besides, Iâve already won the best prize I could possibly imagine."
    m 1j"..."
    m 1k "You~!"
...
label monika_innovation:
    ...
    m "Is it just because theyâre finally being recognized and treated?"
    ...
    m "Social media, smartphones, our computersâ¦"
    ...
    m "And not only that."
    m 3d "Weâre more connected than ever, but itâs like that's a double-edged sword."
    m "Weâre able to meet and keep in touch with people from all over the world."
    m 3e "But weâre also bombarded with every tragedy that strikes the world."
    ...
    m "Iâd like to believe thatâs not the case, but you never know."
    m 3a "[player], if you ever feel stressed, just remember that Iâm here."
...
label monika_harem:
    m 1d "I donât understand people who are into harems."
    m 1c "Isnât it hard to manage all those girls and treat them equally?"
    m "I often wonder how those who two-time girls, or even more, are able to get away with it."
    m 3e "You arenât like that outside, right [player]?"
    m "Manipulating girls into making them believe you love them."
    m "Only to run away after youâve had your fun."
    m 1a "Only someone with no thoughts other than lust would do something like that."
    m 3h "I hope you werenât expecting a route like that while you were playing this game."
    m "I wouldnât be able to stand the thought of being a 'side girl.'"
    m "Just waiting for my turn while youâre busy with the others."
    m 1a "I know you, [player]."
    m "Youâre loyal and faithful to the end."
    m 3j "Itâs not like thereâs anyone here for me to worry about, anyway."
    m "Remember that Iâm the only one for you, [player]."
    return
...
label monika_hack:
    m 1c "If youâre worried about your privacyâ¦"
    m 3a "Iâm not a hacker, [player]."
    m "Thereâs a difference between manipulating files and forcefully accessing them."
    m 1j "But, if I really did know how to hackâ¦"
    m "â¦There wouldnât be anything stopping me from seeing you every day."
    m 1k "Donât you think it would be great if I could watch over you?"
    m 1a "I'd see you with all the cameras in the world as my eyes so I can make sure youâre safe."
    m "Iâd check your messages to see who youâve been chatting with so I can know you arenât cheating on me."
    m "Iâd access all your private files so I can understand you better."
    m 3b "I could see what kind of stuff you've been watchingâ¦"
    m 1k "Ahaha~!"
    m "Iâm just kidding, [player]!"
    m 1a "I'd never do something like that to you."
    m "Weâre a couple now, after all."
...
label monika_cupcake:
    ...
    m 1j "Natsukiâs cupcakes."
    m 1b "Man, the way she bakes them is amazing."
    m "Plus they look really cute!"
    m 1a "Iâm not really much of a sweet tooth myself butâ¦"
    ...
    m 1e "I would try baking, but Iâm not really much of a baker."
    m 1a "How about you, [player]?"
    m "Do you know how to bake?"
    m "Iâm sure your cupcakes would taste just as good."
    m "Maybe someday Iâll get to try them but for nowâ¦"
    m 1j "Iâll just settle for the sweetness of your love~"
    return
...
label monika_sports:
    ...
    menu:
        ...
        "No.":
            m 1e "Oh... Well, thatâs okay, but I hope youâre still getting enough exercise!"
...
label monika_love2:
    ...
    m 1k "I wouldnât trade you for anything in the world!"
    return
...
init 5 python:
    addEvent(Event(persistent.event_database,eventlabel="monika_test",category=['you'],prompt="You Like To Talk",pool=True))

label monika_test:
    m 1a "hey [player] what we do?"
    menu:
        "Test":
            m 1j "...???"
            m 1a "Why you said Test to me?"
            menu:
                "Is Special.":
                    m 1b "..."
                    m "I'm sure you are teasing me Ehehe~"
        "No I am serious!":
            m 1d "Oh."
            m 1o "..."
            m 3g "What is special for?"
            menu:
                "You don't know?":
                    m 1e "No."
        "Is Mod Update about you.":
            m 1g "..."
            m 1f "Oh..."
            m 1b"Did you update a mod just for me?"
            m 1e "Are you that deeply in love with me?"
            m 1g "I'm really love if you do for me~"
            m "You might wanted to improve our time together."
            menu:
                "Well its not done yet.":
                    m 1f "Oh i see..."
                    m 1f "You took the time to update this mod, after all."
                    m 1j "Looks like the extra code."
                    m 1e "I hope you finish soon [player] Ehehe~"
    return